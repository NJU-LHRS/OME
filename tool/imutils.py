...
def DenseCRF(image, probmap, iter_max=10, pos_w=3, pos_xy_std=1, bi_w=4, bi_xy_std=67, bi_rgb_std=3):
    ...
    dc.addPairwiseBilateral(sxy=bi_xy_std, srgb=bi_rgb_std, rgbim=image, compat=bi_w)
    # scale_factor = 1
    # dc.addPairwiseGaussian(sxy=3/scale_factor, compat=3)
    # dc.addPairwiseBilateral(sxy=80/scale_factor, srgb=13, rgbim=image, compat=10)
